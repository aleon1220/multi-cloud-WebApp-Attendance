...
public class Json2Map {
	...
	public static void main(String[] args) {
		...
		Type authorization = new TypeToken<Map<String, Authorization>>(){}.getType();
		// TODO Auto-generated method stub
		
		Map<String, Authorization> authorizationMap = gson.fromJson(jsonFromMS, authorization);
		
		Map<String, Object> retMap = new Gson().fromJson(jsonFromMS, new TypeToken<HashMap<String, Object>>() {}.getType()	);
		
		Map<String, Object> map = new Gson().fromJson(jsonFromMS, new TypeToken<HashMap<String, Authorization>>() {}.getType()	);
