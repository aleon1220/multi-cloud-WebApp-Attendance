...
public class ConversionJson2Map {
    ...
    public static void main(String[] args) {
        ...
        Type authorization = new TypeToken<Map<String, StudentAuthorization>>() {
        }.getType();
        // TODO Auto-generated method stub

        Map<String, StudentAuthorization> authorizationMap = gson.fromJson(jsonFromMS, authorization);
