...
public interface GeoIPServiceSoap {
     ...
     * @param ipAddress
     * @return
     *         returns serviceClients.geoIP.GeoIP
     */
    ...
    @ResponseWrapper(localName = "GetGeoIPResponse", targetNamespace = "http://www.webservicex.net/", className = "serviceClients.geoIP.GetGeoIPResponse")
    ...
    @RequestWrapper(localName = "GetGeoIPContext", targetNamespace = "http://www.webservicex.net/", className = "serviceClients.geoIP.GetGeoIPContext")
    @ResponseWrapper(localName = "GetGeoIPContextResponse", targetNamespace = "http://www.webservicex.net/", className = "serviceClients.geoIP.GetGeoIPContextResponse")
